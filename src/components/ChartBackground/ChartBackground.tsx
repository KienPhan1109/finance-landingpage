...
import styles from "./ChartBackground.module.css";
...
export function ChartBackground(_props: ChartBackgroundProps) {
  ...
  useEffect(() => {
    ...
    // ── Mouse Interaction Listeners (Silky Smooth Lerp + Velocity Tracking) ──
    ...
    const render = () => {
      ...
      // Frame-rate independent exponential smoothing (120 FPS anti-stutter)
